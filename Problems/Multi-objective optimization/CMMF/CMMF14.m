    ...
    methods
        ...
        function PopObj = CalObj(obj, X)
            ...
            for i = 1 : N
                if X(i, 1) > -0.5
                    ...
                    THETA(i) = 2/pi * atan(abs(X(i, 2)) / max(abs(X(i, 1)+0.5), 1e-6));
                end
            end
            ...
            for i = 1 : N
                if X(i, 1) > -0.5
                    % Peak 1: Circle radius sqrt(0.64)
                    T(i) = (0.64 - (X(i, 1)^2 + X(i, 2)^2))^2 + h(i);
                else
                    % Peak 2: Circle radius sqrt(0.25) at (-0.5, 0)
        ...
        function PopCon = CalCon(obj, X)
            ...
            for i = 1 : N
                if X(i, 1) > -0.5
                    val = X(i, 1)^2 + X(i, 2)^2;
                    % Peak at 0.64. Feasible band: [0.55, 0.75]
                    PopCon(i, 1) = max(0.55 - val, val - 0.75);
                else
                    val = (X(i, 1)+0.5)^2 + X(i, 2)^2;
                    % Peak at 0.25. Feasible band: [0.2, 0.3]
                ...
                if X(i, 1) > -0.5
                    ...
                    th = 2/pi * atan(abs(X(i, 2)) / max(abs(X(i, 1)+0.5), 1e-6));
                end
